...
// Mock data - replace with API call later and filter by urgency
...
const UrgentPatientsList = () => {
  ...
  return (
    <>
      {/* Main Content */}
      <h1 className="text-3xl font-bold mb-8">Patients with Urgent Tests</h1>
...
export default UrgentPatientsList; 