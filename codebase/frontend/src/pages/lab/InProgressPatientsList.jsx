...
const InProgressPatientsList = () => {
  ...
  return (
    <>
      {/* Main Content */}
      <h1 className="text-3xl font-bold mb-8">Patients with In Progress Tests</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {mockInProgressPatients.map((patient) => (
              <tr
                key={patient.id}
...
export default InProgressPatientsList; 