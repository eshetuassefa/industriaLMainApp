...
const mockInProgressScans = [
  {
    id: 'R002',
    patient: 'Tigist Hailu',
    scanType: 'Blood Chemistry', // Placeholder, should be a scan type
    requestedBy: 'Dr. Yohannes Alemu',
    urgency: 'Urgent',
  },
  // Add more mock in-progress scan data as needed
];
...
const InProgressScansList = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">In Progress Scans</h1>
