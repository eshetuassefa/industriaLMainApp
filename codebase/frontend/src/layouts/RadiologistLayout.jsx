...
const navigation = [
  ...
  {
    name: "Pending Scans",
    href: "/radiology/dashboard/pending-scans",
    icon: ClockIcon,
  },
  {
    name: "In progress Scans",
    href: "/radiology/dashboard/in-progress-scans",
    icon: ClockIcon,
  },
  {
    name: "Completed today",
    href: "/radiology/dashboard/completed-scans",
    icon: DocumentTextIcon,
  },
  {
    name: "Urgent Scans",
    href: "/radiology/dashboard/urgent-scans",
    icon: DocumentTextIcon,
  },
  { name: "Settings", href: "/radiology/dashboard/settings", icon: CogIcon },
];
