 ...
 */
router.post("/staffs/register", admin_controller_1.registerStaffController);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.get("/staffs/getall", admin_controller_1.getAllStaffsController);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.get("/staff/getsingle/:id", admin_controller_1.getStaffByIdController);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.put("/staff/update/:id", admin_controller_1.updateStaffController);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.delete("/staff/delete/:id", admin_controller_1.deleteStaffController);
